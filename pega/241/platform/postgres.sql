...
-- DROP SCHEMA IF EXISTS data_232 ;

CREATE SCHEMA IF NOT EXISTS data_232
    AUTHORIZATION postgres;

GRANT ALL ON SCHEMA data_232 TO postgres WITH GRANT OPTION;

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA data_232
...
-- DROP SCHEMA IF EXISTS rules_232 ;

CREATE SCHEMA IF NOT EXISTS rules_232
    AUTHORIZATION postgres;

GRANT ALL ON SCHEMA rules_232 TO postgres WITH GRANT OPTION;

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA rules_232
GRANT ALL ON TABLES TO postgres WITH GRANT OPTION;
...
-- DROP SCHEMA IF EXISTS customer_232 ;

CREATE SCHEMA IF NOT EXISTS customer_232
    AUTHORIZATION postgres;

GRANT ALL ON SCHEMA customer_232 TO postgres WITH GRANT OPTION;

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA customer_232
GRANT ALL ON TABLES TO postgres WITH GRANT OPTION;
